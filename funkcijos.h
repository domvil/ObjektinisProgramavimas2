...
void readfromFileList(string filename, list<Studentas> &sar, int &studentu_skaicius);
void dalintiSarasaList(list<Studentas>&sar, list<Studentas> &vargsiukai, list<Studentas> &moksliukai);
#endif
